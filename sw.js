const CACHE='wocheneinkauf-v10';
const FILES=['./','index.html','style.css?v=6','recipe-model.js?v=1','recipe-data.js?v=1','shopping-amounts.js?v=1','app.js?v=8','auth.js','manifest.json','icon.svg'];
